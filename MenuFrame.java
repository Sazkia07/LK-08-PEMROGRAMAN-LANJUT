...
public class MenuFrame extends JFrame {
    public MenuFrame() {
        ...
        JButton k = new JButton("Pengembalian");
        ...
        k.setBounds(100,180,200,30);
        l.setBounds (100,220,200,30);

        add(s); add(b); add(p); add(t); add(l); add(k);
        ...
        k.addActionListener(e -> new KembaliForm());
